<div class="row justify-content-center">
  <h1 class="text-light mb-4 text-center"><b>Bitácora</b></h1>
        ...
        <form id="formBitacora" class="border bg-light bg-gradient text-dark shadow-lg rounded p-3 text-center">
          ...
          <div class="row mb-2">
            ...
            <div class="col-lg mx-auto justify-content-center">
              ...
              <input type="date" name="bita_fecha" id="bita_fecha" class="form-control rounded-pill" readonly>
            </div>

            <div class="col-lg mx-auto justify-content-center">
              <label for="bita_malware" class="form-label fw-bold">Malware <i class="fa-solid fa-skull"></i></label>
              <input type="number" name="bita_malware" id="bita_malware" class="form-control rounded-pill" placeholder="Ingrese el número" required>
            </div>

            <div class="col-lg">
              <label for="bita_phishing" class="form-label fw-bold">Phishing <i class="fa-solid fa-bangladeshi-taka-sign"></i></label>
              <input type="number" name="bita_phishing" id="bita_phishing" class="form-control rounded-pill" placeholder="Ingrese el número" required>
            </div>

            <div class="col-lg">
              <label for="bita_coman_cont" class="form-label fw-bold">Comando y Control <i class="fa-solid fa-folder-open"></i></label>
              <input type="number" name="bita_coman_cont" id="bita_coman_cont" class="form-control rounded-pill" placeholder="Ingrese el número" required>
            </div>
          ...
          <div class="row mb-2">
            ...
            <div class="col-lg">
              ...
              <input type="number" name="bita_cryptomineria" id="bita_cryptomineria" class="form-control rounded-pill" placeholder="Ingrese el número" required>
            </div>

            <div class="col-lg">
              <label for="bita_ddos" class="form-label fw-bold">Denegación de Servicio <i class="fa-solid fa-magnifying-glass"></i></label>
              <input type="number" name="bita_ddos" id="bita_ddos" class="form-control rounded-pill" placeholder="Ingrese el número" required>
            </div>

            <div class="col-lg">
              <label for="bita_conex_bloq" class="form-label fw-bold">Conexiones Bloqueados <i class="fa-solid fa-magnifying-glass"></i></label>
              <input type="number" name="bita_conex_bloq" id="bita_conex_bloq" class="form-control rounded-pill" placeholder="Ingrese el número" required>
            </div>
  ...
  <div class="col-lg-6 justify-content-center bg-light bg-gradient roundend">

  </div>
</div>

<script src="build/js/bitacora/index.js"></script>